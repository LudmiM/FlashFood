...
('Carlos', 'Gómez', 'carlos.gomez@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image1.jpg', NOW(), NOW()),
('Juan', 'Martínez', 'juan.martinez@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image2.jpg', NOW(), NOW()),
('María', 'Fernández', 'maria.fernandez@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image3.jpg', NOW(), NOW()),
('Laura', 'Pérez', 'laura.perez@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image4.jpg', NOW(), NOW()),
('Andrés', 'Ramírez', 'andres.ramirez@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image5.jpg', NOW(), NOW()),
('Sofía', 'García', 'sofia.garcia@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image6.jpg', NOW(), NOW()),
('Roberto', 'Hernández', 'roberto.hernandez@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image7.jpg', NOW(), NOW()),
('Claudia', 'Morales', 'claudia.morales@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 2, 'image8.jpg', NOW(), NOW());

-- Ubicacion

INSERT INTO `flashfood`.`locations` (`idCustomer`, `country`, `province`, `city`, `address`) VALUES
(9, 'AR', 'Buenos Aires', 'Buenos Aires', 'Avenida de Mayo 123'),
(10, 'AR', 'Córdoba', 'Córdoba', 'Boulevard San Juan 456'),
...
(8, 'AR', 'Entre Ríos', 'Paraná', 'Urquiza 805'),
...
('La Pizzería', 'pizzeria@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 9, 'pizzeria.jpg', NOW(), NOW()),
('El Rincón Mexicano', 'rincon.mexicano@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 10, 'mexicano.jpg', NOW(), NOW()),
('Sushi House', 'sushi.house@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 11, 'sushi.jpg', NOW(), NOW()),
('Panadería Delicias', 'panaderia.delicias@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 12, 'panaderia.jpg', NOW(), NOW()),
('La Parrilla', 'parrilla@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 13, 'parrilla.jpg', NOW(), NOW()),
('Burger King', 'burger.king@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 14, 'burgerking.jpg', NOW(), NOW()),
('Los Mariscos', 'mariscos@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 15, 'mariscos.jpg', NOW(), NOW()),
('Pasta Italia', 'pasta.italia@gmail.com', '$2a$10$fGPJEl5Twzz.eySDoWUFpeOgZB6yNlRGpbVltGt5/MBQMgHXGSrFu', NULL, 1, 16, 'pastaitalia.jpg', NOW(), NOW());
